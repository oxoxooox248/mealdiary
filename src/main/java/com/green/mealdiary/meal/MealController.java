...
public class MealController {
    ...
    @PostMapping("/tag")
    @Operation(summary = "일지 태그 추가", description = "일지 태그 추가 처리<br>(imeal: 일지pk, tag: 추가할 태그)" +
    ...
    @DeleteMapping("/pic")
    @Operation(summary = "일지 사진 삭제", description = "일지 사진 삭제 처리<br>(imeal: 일지pk, ipic: 사진pk)" +
