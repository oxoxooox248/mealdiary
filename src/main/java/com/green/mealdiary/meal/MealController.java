...
public class MealController {
    ...
    public ResVo updMeal() { return null;}

    @DeleteMapping("/api/meal")
    @Operation(summary = "일지 삭제", description = "???")
    public ResVo delMeal() { return null;}

    @DeleteMapping("/api/meal/pic")
    @Operation(summary = "일지 사진 삭제", description = "???")
    public ResVo delMealPic() {return null;}

    @GetMapping("/api/meal/mark")
    @Operation(summary = "북마크 표시/해제", description = "???")
    public ResVo toggleBookmark() {return null;}

    @DeleteMapping("/api/meal/tag")
    @Operation(summary = "일지 태그 삭제", description = "???")
    public ResVo delMealTag() {return null;}
}
